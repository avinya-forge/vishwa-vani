...
describe('ShlokaMask Component Canvas Tests', () => {
  ...
  beforeAll(() => {
    ...
    HTMLCanvasElement.prototype.getContext = jest.fn(() => mockContext) as unknown as (contextId: "2d" | "bitmaprenderer" | "webgl" | "webgl2", options?: unknown) => RenderingContext | null;
  });
