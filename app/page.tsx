        ...
        <header className="mb-20 text-center relative">
          ...
          <div className="relative z-10">
            ...
            <div className="flex justify-center gap-4">
              <Link href="/study/1" className="px-8 py-3 bg-gradient-to-r from-orange-600 to-amber-600 text-white rounded-full hover:from-orange-700 hover:to-amber-700 transition-all font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                Begin Reading
              </Link>
            </div>
          </div>
