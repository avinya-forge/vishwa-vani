...
export const SCHOLARS_REGISTRY: ScholarEntry[] = [
  // ── Tier 0 — currently live in production ─────────────────────────────────
  {
    ...
    publicDomainSource: 'BBT Gītā As It Is — distributed by ISKCON; HI/MR layers currently template-derived (BUG-057, slated for replacement)',
    licenseNote: 'BUG-057: HI/MR layers are programmatically derived from EN, not authentic per-language scholarship. Replacement queued via SCHOLAR-001 Phase A (Gita Press HI).',
  },
  {
    id: 'sant-dnyaneshwar',
  ...
  // ── Tier 1 — SCHOLAR-001 ranked top-10 acquisition queue ──────────────────
  {
    ...
    publicDomainSource: 'GRETIL (Sanskrit Gītā Bhāṣya, CC-BY); Telang SBE Vol VIII (EN, 1882); Gita Press Gorakhpur (HI editions)',
  },
  {
  ...
  {
    id: 'gandhi-anasakti-yoga',
    displayName: 'Mahatma Gandhi — Anāsakti-yoga',
    era: 'colonial',
    dates: '1869–1948 (discourses 1929–1932)',
    philosophicalSchool: 'karma-yoga-modern',
    tradition: 'independent-modern',
    primaryLanguage: 'gu',
    availableLanguages: ['gu', 'hi'],
    acquisitionStatus: 'queued',
    tier: 1,
    rank: 6,
    schoolSummary: 'Anāsakti-yoga — non-attachment as the ethical core of the Gītā; ahiṃsā as the practical implication; reading from the field of social struggle.',
    publicDomainSource: 'Gujarati original Anāsakti-yoga (1929, public domain); multiple PD HI translations. EN translation (Mahadev Desai 1946) — Indian PD term life+60 expired 2006; verify before ingest.',
    licenseNote: 'Mahadev Desai EN translation copyright status: Indian Copyright Act life+60 → expired 2006. Verify with publisher (Navjivan Trust) before ingest. HI versions multiple PD.',
  },
  {
    id: 'radhakrishnan',
