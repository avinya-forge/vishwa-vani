...
1. **[x] [PO] Feasibility Audit**: Review the legal and technical feasibility of aggregating 10+ translations per book.
2. **[x] [ARCH] Schema Gaps**: Resolve NVF 1.2 vs 1.3 prose support inconsistencies.
3. **[x] [DEV] Gita-Patching**: Finalize Shankara/Ramanuja layers integration.
...
- [ ] **[BATCH-UI-MINOR] UI Density & Responsive Polish**: Consolidates minor UI tasks (> 50 LOC total) covering header states (UI-603), whitespace reduction (UI-606), responsive optimization (UI-607), continue reading component (UI-609), and anchor accessibility (UI-610).
