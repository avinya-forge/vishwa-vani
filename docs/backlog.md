...
- [x] `SCHOLAR-001` **Top 10 Identification**: Research and rank candidates. **Done: 2026-05-02.** Ranked list with philosophical school, language coverage, and source availability:
    1. **Adi Shankara** (788–820 CE) — Advaita Vedanta, Sanskrit Bhashya. EN translations: Gambhirananda (1984, public domain). HI: Gita Press. MR: partial. Highest philosophical authority.
    2. **Ramanuja** (1017–1137 CE) — Vishishtadvaita (qualified non-dualism), Sanskrit. EN: Alkondavilli Govindacharya (1898, public domain). Limited HI/MR. Key for theistic counterpoint to Shankara.
    3. **Madhva** (1238–1317 CE) — Dvaita (pure dualism), Sanskrit. EN: BNK Sharma translations (partial public domain). Essential for devotional-dualist perspective distinct from ISKCON.
    4. **B.G. Tilak** (1856–1920) — Karma Yoga emphasis, Gitarahasya (1915, Marathi original). EN: available. MR: original. Nationalist-activist reading. HIGH PRIORITY for MR slot.
    5. **Sarvepalli Radhakrishnan** (1888–1975) — Neo-Vedanta synthesis, EN. "The Bhagavadgita" (1948). Widely cited modern academic translation + commentary. EN only but authoritative.
    6. **Mahatma Gandhi** (1869–1948) — Anasakti Yoga (non-attachment), EN + Gujarati. "The Gita According to Gandhi" (public domain). Moral-political reading unique in the tradition.
    7. **Sri Aurobindo** (1872–1950) — Integral Yoga, EN. "Essays on the Gita" (public domain). Cosmic-evolutionary perspective distinct from all above.
    8. **Swami Vivekananda** (1863–1902) — Practical Vedanta, EN + Bengali. Multiple Gita lectures (public domain). Bridge between classical and modern.
    9. **Pandurang Shastri Athavale** (1920–2003) — Swadhyaya movement, Marathi/Gujarati. Less documented in English; strong MR resource if texts acquired.
    10. **Jayadayal Goyandka** (Gita Press, 1885–1965) — Hindi scholarship, devotional. "Srimad Bhagavad Gita" Gita Press Hindi edition (public domain). PRIMARY source for authentic HI layer (BUG-057 fix).
    **Acquisition priority for BUG-057**: Goyandka (HI) + Tilak Gitarahasya (MR) → directly resolve the template-generated layer problem.
...
- [x] `LAB-GITA-004` **Sanyasa Paradox Resolver** (Ch 4, 5) — Interactive: "How to renounce while still acting?" Map life situation to Krishna's guidance on Karma Yoga vs. pure renunciation. Resolves Ch 3↔5 apparent contradiction. **Done: 2026-05-02.** 5 paradoxes (surgeon, reformer, artist, parent, seeker). Renounce vs Act paths each with teaching + gitaRef + insight. Convergence reveal. Registered in registry. 5 tests passing.

Priority Tier 2 — knowledge & realization:
- [x] `LAB-GITA-005` **Visvarupa Contemplation Guide** (Ch 11) — Text-triggered meditation for Arjuna's awe-struck vision of Universal Form. Guided progressive revelation using Ch 11 verses. Vedic cosmology overlay. **Done: 2026-05-02.** 8 stages of Arjuna's vision, each with verse + contemplation prompt. Progress tracking. Registered in registry. 5 tests passing.
- [x] `LAB-GITA-006` **Royal Science Decoder** (Ch 9) — Progressive unlock of 9 secrets Krishna reveals. Each "secret" unlocks a meditation/practice. Covers the entirely uncovered Ch 9. **Done: 2026-05-02.** 9 Rāja Vidyā secrets, progressive reveal mechanic, daily practice per secret. Registered in registry. 5 tests passing.
- [x] `LAB-GITA-007` **Jnana Progression Path** (Ch 7) — Map 7 stages of knowing: Brahman → Paramatman → Purusha → Heart → Direct realization. Daily journaling of current stage. Covers uncovered Ch 7. **Done: 2026-05-02.** 7 knowledge stages, self-assessment, stage-specific practice. Registered in registry. 5 tests passing.
- [x] `LAB-GITA-008` **Purushottama Self-Inquiry** (Ch 15) — Interactive diagram: Kshatraja (perishable tree) → Akshara (imperishable) → Purushottama (Supreme). Self-assessment of current consciousness level. Covers uncovered Ch 15. **Done: 2026-05-02.** 4-question self-assessment, 3-level result, BG 15 verse mapping. Registered in registry. 5 tests passing.

Priority Tier 3 — advanced & synthesis:
- [x] `LAB-GITA-009` **Dharmic Conflict Resolver — Modern Edition** (Ch 2, 4, 16, 18) — Map modern dilemmas (career/family, honesty/mercy) to Gita framework. Outputs relevant verses + Krishna's principle. **Done: 2026-05-02.** 6 modern dilemmas, dharmic analysis + principle + resolution path per conflict. Registered in registry. 5 tests passing.
- [x] `LAB-GITA-010` **Verse Guna Analyzer** (Ch 14–17) — For each verse analyze dominant Guna (Sattva/Rajas/Tamas). Visualize how Krishna's language elevates consciousness across the chapter arc. **Done: 2026-05-02.** 4 chapter profiles (Ch 14–17), key verse tags with Guna, chapter arc narrative. Registered in registry. 5 tests passing.
- [x] `LAB-GITA-011` **Commentary Comparison Tool** (All chapters) — Side-by-side diff: ISKCON (Prabhupada) vs. Sant Dnyaneshwar. Highlights philosophical divergence (devotion vs. knowledge, transcendence vs. immanence). **Done: 2026-05-02.** 5 verse pairs across Ch 2/3/9/12/18. Sky-blue (ISKCON) vs amber (Dnyaneshwar) columns. Philosophical divergence reveal mechanic. Registered in registry. Tests added in D2-S1 test file.
- [x] `LAB-GITA-012` **Marathi Heritage Explorer** (All chapters) — Celebrate 13th-century Warkari tradition. 3-layer display: original shloka → Dnyaneshwari verse → modern Marathi. Cultural + historical context. **Done: 2026-05-02.** 5 verses across Ch 2/4/9/13/18. 3-layer toggle (Sanskrit / 13th Century / Modern). Cultural note + historical context panel. Registered in registry. Tests added.
- [x] `LAB-GITA-013` **Consciousness State Mapper** (Ch 7, 13, 15) — Journey through 4 states: Jagrat/Swapna/Sushupti/Turiya. Map to Gita verses. Track meditation state. Cross-references Mandukya Upanishad when available. **Done: 2026-05-02.** Explore Map mode (4 states × 2–3 Gita verses + Mandukya cross-ref + practice) + 3-question quiz → dominant state result. Registered in registry. Tests added.
