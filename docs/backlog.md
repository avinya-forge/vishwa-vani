...
- [ ] TASK-102: Implement Email/Password magic link flow for passwordless login (1 WU)
- [ ] TASK-103: Scaffold `/profile` route with protected Server Components (1 WU)
- [ ] TASK-104: Add client-side user session synchronization (`'use client'` boundary) (1 WU)
